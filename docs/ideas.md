...
| **SEC-006** | Missing Brute-Force Rate Limiting | **Medium** | ⏳ **PENDING** | Credentials, reset tokens, and endpoints are vulnerable to flooding. | [app.js](file:///home/bhargab/WebD/invoice-client-management/server/src/app.js) |
| **SEC-007** | Missing HTTP Security Headers | **Medium** | ⏳ **PENDING** | Lack of headers like CSP, HSTS, and Frame options exposes browser shell. | [app.js](file:///home/bhargab/WebD/invoice-client-management/server/src/app.js) |
...
| **SEC-009** | Information Leakage via `X-Powered-By` Header | **Low** | ⏳ **PENDING** | Leaks Express.js runtime framework to external observers. | [app.js](file:///home/bhargab/WebD/invoice-client-management/server/src/app.js) |
